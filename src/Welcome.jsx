    ...
    <>
      <div className='welcome-container'>
        ...
        <img
          ...
          src="https://i.ibb.co/VWq350H/generate-a-cool-3d-rainbow-colours-splash-text-s-4.jpg"
          alt="generate-a-cool-3d-rainbow-colours-splash-text-s-4"
          border="0"
        />

        <p className='welcome-p-text'>
          Click on the button below to start your loan application with us today
        </p>
